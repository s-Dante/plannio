...
const styles = {
    ...
    input: "h-11 w-full rounded-full border-0 bg-[#d9dfe5]/70 focus-visible:ring-1 focus-visible:ring-[var(--color-accent)] shadow-inner px-5 text-base placeholder:text-[var(--color-sisth)]/60 text-[var(--color-sisth)]",
    selectTrigger: "w-full h-11 rounded-full border-0 bg-[#d9dfe5]/70 shadow-inner px-5 text-base text-[var(--color-sisth)] focus:ring-1 focus:ring-[var(--color-accent)] hover:bg-[#d9dfe5]/90 transition-colors",
